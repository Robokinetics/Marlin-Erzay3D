...
<b>Примечание:</b> у принтеров Erzay3D 2016 года производства и ранее рекомендуется значение <b>#define DELTA_PRINTABLE_RADIUS</b> устанавливать не более <b>80.0</b>;
