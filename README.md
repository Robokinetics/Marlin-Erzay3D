...
21. Для владельцев принтеров <b>Erzay3D</b>, выпущенных в <b>2016</b> году и ранее необходимо проделать дополнительные манипуляции:
	...
	1. Закомментируйте строчку <b>#define MKS_MINI_12864</b>, добавив два слэша <b>//</b> в начало строки, чтобы получилось так: <b>//#define MKS_MINI_12864</b>;
	2. Раскомментируйте строку <b>//#define U8GLIB_SSD1306</b>, удалив два слеша <b>//</b> из начала строки;
