...
21. Для владельцев принтеров <b>Erzay3D</b>, выпущенных в <b>2016</b> году и ранее необходимо проделать дополнительные манипуляции:
	1. В файле <b>Configuration.h</b> закомментируйте строчку <b>#define MKS_MINI_12864</b>, добавив два слэша <b>//</b> в начало строки, чтобы получилось так: <b>//#define MKS_MINI_12864</b>;
