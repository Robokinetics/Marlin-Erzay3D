...
11. Для поддержки графических дисплеев добавьте библиотеку U8glib, если этого ещё не сделали (Ссылка на репозиторий: https://github.com/olikraus/U8glib_Arduino). Зайдите в меню "Скетч->Подключить библиотеку->Добавить .ZIP библиотеку...". Выберите файл из папки с прошивкой: "lib/u8glib_arduino_v1.18.1.zip";
