...
21. Для владельцев принтеров <b>Erzay3D</b>, выпущенных в <b>2016</b> году и ранее необходимо проделать дополнительные манипуляции:
	1. В файле <b>Configuration.h</b> заменить строку <b>#define MOTHERBOARD BOARD_MKS_GEN_13</b> на <b>#define MOTHERBOARD BOARD_RAMPS_13_EFB</b>
	2. Закомментируйте строчку <b>#define MKS_MINI_12864</b>, добавив два слэша <b>//</b> в начало строки, чтобы получилось так: <b>//#define MKS_MINI_12864</b>;
	3. Раскомментируйте строку <b>//#define U8GLIB_SSD1306</b>, удалив два слеша <b>//</b> из начала строки;
	4. В строке <b>#define TEMP_SENSOR_0 11</b> число <b>11</b> заменить на <b>1</b>;
