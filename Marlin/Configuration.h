...
#define STRING_CONFIG_H_AUTHOR "LLC \"ROBOKINETIKA\"" // "ООО «Робокинетика»" Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Erzay3D"
...
#define DELTA
  ...
  #define DELTA_SEGMENTS_PER_SECOND 85
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_CALIBRATION_RADIUS DELTA_PRINTABLE_RADIUS - 5 // mm
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 174 }  // default steps per unit for Kossel (GT2, 20 tooth)
...
#define PREHEAT_2_FAN_SPEED   35 // Value from 0 to 255
