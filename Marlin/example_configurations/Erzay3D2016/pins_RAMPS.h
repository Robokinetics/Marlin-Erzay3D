 ...
 */
  ...
  #define X_SERIAL_TX_PIN    59//40
  #define X_SERIAL_RX_PIN    63
  #define X2_SERIAL_TX_PIN   -1
  #define X2_SERIAL_RX_PIN   -1

  #define Y_SERIAL_TX_PIN    64//59
  #define Y_SERIAL_RX_PIN    40//64
  #define Y2_SERIAL_TX_PIN   -1
  #define Y2_SERIAL_RX_PIN   -1

  #define Z_SERIAL_TX_PIN    44//42
  #define Z_SERIAL_RX_PIN    42//65
  #define Z2_SERIAL_TX_PIN   -1
  #define Z2_SERIAL_RX_PIN   -1

  #define E0_SERIAL_TX_PIN   66//44
  #define E0_SERIAL_RX_PIN   65//66
...
//////////////////////////
  ...
  //
    ...
    //
      ...
      #define LCD_PINS_RS       16//27
      #define LCD_PINS_ENABLE   17//29
      #define LCD_PINS_D4       23//25
