...
#define DEFAULT_STEPPER_DEACTIVE_TIME 24*60*60
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE    180  // (mm/s) Unload filament feedrate. This can be pretty fast.
  ...
  #define PAUSE_PARK_NOZZLE_TIMEOUT         60*2  // (seconds) Time limit before the nozzle is turned off for safety.
...
#define CUSTOM_USER_MENUS
  ...
  #define USER_DESC_1 "Домой"
  #define USER_GCODE_1 "G28"

  #define USER_DESC_2 "Преднагрев PLA"
  #define USER_GCODE_2 "M140 S" STRINGIFY(PREHEAT_1_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_1_TEMP_HOTEND)

  #define USER_DESC_3 "Преднагрев ABS"
  #define USER_GCODE_3 "M140 S" STRINGIFY(PREHEAT_2_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_2_TEMP_HOTEND)

  #define USER_DESC_4 "Автокалибровка стола"
  #define USER_GCODE_4 "G28\nG29 P1\nG29 T0\nG29 S-1\nG29 A\nM500"

  #define USER_DESC_5 "Полная автокалибровка"
