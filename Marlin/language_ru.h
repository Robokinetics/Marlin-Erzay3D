...
#define WELCOME_MSG                         MACHINE_NAME " " SERIAL_NUMBER
...
#define MSG_USER_MENU                       _UxGT("Быстрые команды")
#define MSG_UBL_DOING_G29                   _UxGT("Выполняю G29")
...
#define MSG_UBL_OUTPUT_MAP_BACKUP           _UxGT("Забэкапить сетку")
...
#define MSG_HOME                            _UxGT("Выполни \"Домой\"") // Used as MSG_HOME " " MSG_X MSG_Y MSG_Z " " MSG_FIRST
#define MSG_FIRST                           _UxGT("сперва")
...
#endif
#define MSG_INFO_MIN_TEMP                   _UxGT("Мин. темп.")
...
#define MSG_ERR_HOMING_FAILED               _UxGT("Парковка не удалась")
#define MSG_ERR_PROBING_FAILED              _UxGT("Не удалось снять пробу")
#define MSG_M600_TOO_COLD                   _UxGT("M600: Низкая темп.")
